...
public class BigVertex {
    private static Logger LOGGER = Logger.getLogger(BigVertex.class);
     ...
     * @param estCore
     */
    public BigVertex(int vertexId, int estCore) {
        this.vertexId = vertexId;
    ...
    public BigVertex(ArrayList<Integer> neighborsEstCore) {
