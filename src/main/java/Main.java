...
//                "processdata/CA-AstroPh.txt";            //cannot converge
...
//                "processdata/p2p-Gnutella31.txt";        //check
...
//                "processdata/CA-AstroPh.txt";
        ...
        /**
         * ============Distributed Simple Core Decomposition=================
         */
        DistributedSimpleCore distributedSimpleCore = new DistributedSimpleCore();
        ArrayList<ResultSet> resultSetArrayList = distributedSimpleCore.run(datasetName);
